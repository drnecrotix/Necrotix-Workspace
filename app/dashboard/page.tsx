...
export default async function Dashboard() {
  ...
  return <div className="shell">
    <aside className="sidebar"><div className="brand">NECROTIX<br/>WORKSPACE</div><nav className="nav"><Link href="/dashboard">Overview</Link><a href="#projects">Projects</a><a href="#activity">Activity</a><a href="/dashboard/settings/update">Updates</a></nav><div className="side-foot">projects.necrotixlab.com<br/>Independent delivery system</div></aside>
